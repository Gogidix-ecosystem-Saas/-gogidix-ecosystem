...
/**
 * Domain model for Migration Query.
 * Pure domain representation for database-migrations requests.
 */
public class MigrationQuery {
    ...
    public MigrationQuery(String identifier, String environment, boolean includeMetadata) {
